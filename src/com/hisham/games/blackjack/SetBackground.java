...
public class SetBackground extends Activity implements OnClickListener {
	...
	void setTextColors(int red, int green, int blue) {
		// Text colors
		BlackJackActivity.tvBet.setTextColor(Color.rgb(red, green, blue));
		BlackJackActivity.tvBet.setTextColor(Color.rgb(red, green, blue));
		BlackJackActivity.tvDealerScore.setTextColor(Color
				.rgb(red, green, blue));
		BlackJackActivity.tvHighestScore.setTextColor(Color.rgb(red, green,
				blue));
		BlackJackActivity.tvMoney.setTextColor(Color.rgb(red, green, blue));
		BlackJackActivity.tvYourScore.setTextColor(Color.rgb(red, green, blue));
	...
	public void onClick(View v) {
		...
		case R.id.imageViewbg1:
			...
			BlackJackActivity.layout.setBackgroundResource(R.drawable.back1);
		...
		case R.id.imageViewbg2:
			...
			BlackJackActivity.layout.setBackgroundResource(R.drawable.back2);
			setTextColors(255, 255, 255);
			finish();
		...
		case R.id.imageViewbg3:
			...
			BlackJackActivity.layout.setBackgroundResource(R.drawable.back3);
		...
		case R.id.imageViewbg4:
			...
			BlackJackActivity.layout.setBackgroundResource(R.drawable.back4);
			setTextColors(0, 0, 0);
			finish();
		...
		case R.id.imageViewbg5:
			...
			BlackJackActivity.layout.setBackgroundResource(R.drawable.back5);
		...
		case R.id.imageViewbg6:
			...
			BlackJackActivity.layout.setBackgroundResource(R.drawable.back6);
			setTextColors(0, 0, 0);
			finish();
		...
		case R.id.imageViewbg7:
			...
			BlackJackActivity.layout.setBackgroundResource(R.drawable.back7);
		...
		case R.id.imageViewbg8:
			...
			BlackJackActivity.layout.setBackgroundResource(R.drawable.back8);
		...
		case R.id.imageViewbg9:
			...
			BlackJackActivity.layout.setBackgroundResource(R.drawable.back9);
			setTextColors(255, 255, 255);
			finish();
		...
		case R.id.imageViewbg10:
			...
			BlackJackActivity.layout.setBackgroundResource(R.drawable.back10);
			setTextColors(255, 255, 255);
			finish();
		...
		case R.id.imageViewbg11:
			...
			BlackJackActivity.layout.setBackgroundResource(R.drawable.back11);
			setTextColors(255, 255, 255);
			finish();
